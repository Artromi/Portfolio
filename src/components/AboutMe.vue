<template>
  <section>
    ...
    <div class="flex gap-12 py-10 mx-auto">
      <p class="text-2xl leading-10 text-black">
      ...
      <div class="flex-shrink-0 border-2 border-green-100">
        <img class="w-80 h-80 object-cover" src="@/assets/profilbild.jpg" alt="picture of ari" />
      </div>
    </div>
