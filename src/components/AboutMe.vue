    ...
    <div class="mt-16">
      ...
      <div class="flex flex-wrap gap-12 pl-8 mt-8">
        <div class="">
          ...
          <p class="bg-green-100 px-2 mx-1 inline text-2xl">Vue.js</p>
          <p class="bg-green-100 px-2 mx-1 inline text-2xl">HTML</p>
          <p class="bg-green-100 px-2 mx-1 inline text-2xl">CSS</p>
          <p class="bg-green-100 px-2 mx-1 inline text-2xl">Tailwind</p>
          <p class="bg-green-100 px-2 mx-1 inline text-2xl">Git(Hub)</p>
        </div>
        <div>
          <p class="text-2xl p-1">I have basic experience with:</p>
          <div class="">
            <p class="bg-green-100 p-1 m-1 inline text-2xl">TypeScript</p>
            <p class="bg-green-100 p-1 m-1 inline text-2xl">Node.js</p>
            <p class="bg-green-100 p-1 m-1 inline text-2xl">Postman</p>
          </div>
        </div>
      </div>
    </div>
